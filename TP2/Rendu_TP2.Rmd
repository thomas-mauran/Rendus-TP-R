...
ggplot(smallTable,
  ...
  labs(x = "", y = "Percent of Chamber Members") +
  theme_classic()

```

Ici je trouve cela plus pertinent de representer les données das un graph stacké pour bien mettre en exergue la proportion d'homme bien plus importante
